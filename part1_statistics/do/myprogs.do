...
program bymyPCT 
	...
	global statlist4 ="p97_5`varM'=r(r14) p99`varM'=r(r15) p99_5`varM'=r(r16) p99_9`varM'=r(r17) p99_99`varM'=r(r18)" 
	qui statsby $statlist1 $statlist2 $statlist3 $statlist4, by(`4') saving(PC_`prefix'`varM'`suffix',replace): ///
	_pctile `varM',p(1,2.5,5,10,12.5,25,37.5,50,62.5,75,87.5,90,95,97.5,99,99.5,99.9,99.99) 
