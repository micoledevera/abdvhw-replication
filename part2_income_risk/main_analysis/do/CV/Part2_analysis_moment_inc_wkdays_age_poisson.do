...
log using "$maindir\risk_measure\log\momentbased_${aggind}_${chosen_sex}_${inc_var}_${spl}_poisson_ppml_inc_wkdays_age", text replace
...
** with agg indicator		
global vars log_${inc_var}_lag tot_inc_lag_dum days_lag1 age age_sq ///           
			age_daysl agesq_daysl ///
			age_incdum agesq_incdum ///
			age_inclag agesq_inclag
...
** SAVE DATA
compress
save "$savepath\IR_moment_cvar_${aggind}_${chosen_sex}_${inc_var}_${spl}_poisson_ppml_inc_wkdays_age.dta", replace
