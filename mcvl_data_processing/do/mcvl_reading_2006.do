/*----------------------------
Read MCVL 2006 and save as dta
----------------------------*/
...
** INDIVIDUALS
insheet using "$raw\mcvl_${v_old}\PERSANON.trs", clear delimiter(";")
...
** CONVIVIENTES
insheet	using "$raw\mcvl_${v_old}\CONVIVI.trs", clear delimiter(";")
...
** DIVISION
insheet	using "$raw\mcvl_${v_old}\DIVISION.trs", clear delimiter(" ")
...
foreach i of numlist 1/12 {
	insheet	using "$raw\mcvl_${v_old}\COTIANON`i'.trs", clear delimiter(";")
...
insheet using "$raw\mcvl_${v_old}\COTIANON13.trs", clear delimiter(";")
...
foreach i of numlist 1/3 {
	insheet using "$raw\mcvl_${v_old}\AFILANON`i'.trs", clear delimiter(";")
...
** RETIREMENT BENEFITS
insheet	using "$raw\mcvl_${v_old}\PREANON.trs", clear delimiter(";")
...
drop v3 v5-v9 v12-v13 v15-v20 v23-v26 v30-v33
...
** TAX DATA
insheet	using "$raw\mcvl_${v_old}\DATOS_FISCALES.trs", clear delimiter(";")
